<template>
  <div
    class="border-2 border-gray-300 rounded-2xl p-8 max-w-xl mx-auto bg-white shadow-md space-y-6"
  >
...
// Filter logic
watch(search, () => {
  dataRender.value = data.value.filter((e) => e.toLowerCase().includes(search.value.toLowerCase()))
})
</script>
